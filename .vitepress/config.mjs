...
export default defineConfig({
  ...
  srcExclude: [
    ...
    'blog/superbuy-article-prompt.md',
    'blog/superbuy-internal-link-rules.md',
    'blog/superbuy-product-reference.md',
    'blog/superbuy-review-report.md',
    'blog/superbuy-topic-list.md',
