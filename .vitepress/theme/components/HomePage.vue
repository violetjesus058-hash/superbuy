  ...
  <main class="modern-home">
    <section class="hero-section">
      <div class="page-container hero-content">
        ...
        <h1>Superbuy Spreadsheet <span>2026</span></h1>
        <p class="hero-copy">
          Discover organized Superbuy finds across clothing, shoes, pants, hats, accessories and electronics,
        ...
        <div class="hero-actions">
          <div class="cta-preview-wrap cta-preview-spreadsheet">
            <div class="cta-preview-card" aria-hidden="true">
              <img src="/images/superbuy-spreadsheet-preview.png" alt="Superbuy Spreadsheet preview showing curated product categories and shopping links" title="Superbuy Spreadsheet preview" />
          ...
          <div class="cta-preview-wrap cta-preview-shopping">
            <div class="cta-preview-card" aria-hidden="true">
              <img src="/images/superbuy-shopping-preview.png" alt="Superbuy shopping preview showing product categories and item options" title="Superbuy shopping preview" />
    ...
    <section id="essential-guides" class="section section-muted essential-guides">
      <div class="page-container">
        <div class="section-heading section-heading-left guides-heading">
          ...
          <p>New to Superbuy? These short guides explain how the platform works, what the spreadsheet is for and how to begin with a clearer plan.</p>
        </div>
...
const guideCards = [
  {
    ...
    title: 'How to Buy with Superbuy',
  ...
  },
  {
    ...
    title: 'What Is the Superbuy Spreadsheet?',
  ...
  {
    label: 'Why it helps',
    title: 'Key Benefits of Superbuy',
